...
import {fetchLatestExchangeRates} from "../utils";
import {createPost as createPostWeb, fetchPosts, getPostComments} from "../services/posts";
...
export const requestExchangeRates = createAction(ActionType.REQUEST_EXCHANGE_RATES, fetchLatestExchangeRates);
...
export const listPostComments = createAction(ActionType.POST_GET_COMMENTS, getPostComments);